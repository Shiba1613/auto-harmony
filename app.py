...
translations = {
    "ja": {
        ...
        "penta_weight": "ペンタトニック重み",
        "harmony_volume": "ハモリ音量",
        "advanced_settings": "詳細設定",
        "triad_weight": "トライアド重み",
        "vi_weight": "V-I進行重み",
        "timbre_warp": "声質変換",
        "fixed_segment": "固定長分割",
        "accurate_f0": "正確なf0",
    ...
    "en": {
        ...
        "penta_weight": "Pentatonic Weight",
        "harmony_volume": "Harmony Volume",
        "advanced_settings": "Advanced Settings",
        "triad_weight": "Triad Weight",
...
def run_full_analysis(x, fs, penta=0.5, precise_f0=False, key_original=True, W_triad=0.2, W_vi=0.5):
    """
    音声波形 x を受け取り、WORLD分析とキー判定を実行する。
    """
    # --- 1. WORLD分析 ---
    try:
        x = x.astype(np.float64) # PyWorld用にfloat64に変換
        if precise_f0:
